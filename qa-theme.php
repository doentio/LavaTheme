...
class qa_html_theme extends qa_html_theme_base
{
	...
	public function favorite()
	{
		...
		if (!empty($feed)) {
			$this->output('<a href="'.$feed['url'].'" title="'.@$feed['label'].'"><img src="'.$this->rooturl.'images/rss.png" alt="" width="16" height="16" class="qa-rss-icon"/></a>');
		}
	}
	...
	public function attribution()
	{
		$this->output(
			...
			'&nbsp;| Theme by <a href="http://xh6liiypqffzwnu5734ucwps37tn2g6npthvugz3gdoqpikujju525yd.onion/index.php/user/Faw">Faw</a>',
			'</div>'
		);
